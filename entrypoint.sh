...
## RUN CONTAINER
launch_cmd="/usr/bin/python3 main.py --listen 0.0.0.0 --port 8188 --disable-auto-launch --enable-manager --reserve-vram 4.0 --disable-cuda-malloc --use-pytorch-cross-attention"
